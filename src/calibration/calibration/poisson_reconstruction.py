...
if __name__ == '__main__': 
    ...
    test_data_dir = os.path.join(pkg_root, 'test_data')
    table_save_dir = os.path.join(pkg_root, 'load')

    table2 = np.load(os.path.join(table_save_dir, "table_3_smooth.npy"))
    ...
    test_img = cv2.imread(os.path.join(test_data_dir, "sample_13.jpg"))
